...
2. **Подробное объяснение** - развернутое разъяснение с деталями
3. **Правовые основания** - конкретные статьи, законы, нормы
4. **Практические аспекты** - как это применяется на практике
5. **Важные моменты** - ключевые нюансы и особенности
6. **Дополнительная информация** - связанные вопросы или рекомендации
...
- Используй нумерованные списки для последовательности

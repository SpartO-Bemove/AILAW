...
st.set_page_config(page_title="neuralex", page_icon="logo/logo.png", layout="wide")
...
if os.path.exists(logo_path):
    ...
    st.markdown(f"""
    <div class="st-title">
        <img src="data:image/png;base64,{encoded_image}" alt="neuralex Logo" class="logo">
        <span>neuralex - An AI Legal Assistant </span>
    </div>
    """, unsafe_allow_html=True)
else:
    st.markdown("""
    <div class="st-title">
        <span>neuralex - Your Legal Assistant 📖</span>
    </div>
    """, unsafe_allow_html=True)

# Sidebar Info
st.sidebar.header("About neuralex")
st.sidebar.markdown("""
**neuralex** is a free, open-source AI legal assistant that helps answer legal questions.

Visit our website: [neuralex](https://neuralex.com)
...
# Create neuralex instance
law = neuralex(llm, embeddings, vector_store)
